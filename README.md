...
docker run -it --rm --name short-video-maker -p 3123:3123 -e LOG_LEVEL=debug -e PEXELS_API_KEY="M1HchicH4JxgGTMwidQcyyY9RjdvLn8ZOqNG2C4ucmiJ8OZtvX96QPuE" short-video-maker-local


docker build -t short-video-maker-local -f main.Dockerfile .